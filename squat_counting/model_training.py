...
#this code is executed  for  single time create the tow models (model_squat and model2_squat)
import pandas as pd
...
joblib.dump(model, 'squat_counting/model_squat.pkl')
joblib.dump(label_encoder,'squat_counting/label_encoder.pkl')
joblib.dump(model2, 'squat_counting/model2_squat.pkl')
