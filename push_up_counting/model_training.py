...
df = pd.read_csv('push_up_counting\\annotated_angles.csv')
...
joblib.dump(model, 'push_up_counting/model_push_up.pkl')
joblib.dump(label_encoder,'push_up_counting/label_encoder_push_up.pkl')
joblib.dump(model2, 'push_up_counting/model2_push_up.pkl')
